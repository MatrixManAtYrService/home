...
setopt SHARE_HISTORY # Share the same history between all shells
setopt APPEND_HISTORY # A shell appends to the history file on exit, rather than replacing it
